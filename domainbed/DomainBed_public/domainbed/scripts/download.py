...
def download_vlcs(data_dir):
    ...
    # download_and_extract(" https://drive.google.com/file/d/1yDuLrJdPSvMbTmpq-7XmwG0HnJengD-T",
    #                        os.path.join(data_dir, "VLCS.tar.gz"))
    
    download_and_extract(" https://drive.google.com/file/d/1yDuLrJdPSvMbTmpq-7XmwG0HnJengD-T",
                           os.path.join(data_dir, "VLCS.zip"))
...
def download_pacs(data_dir):
    ...
    download_and_extract("https://drive.google.com/drive/folders/0B6x7gtvErXgfUU1WcGY5SzdwZVk?resourcekey=0-2fvpQY_QSyJf2uIECzqPuQ&usp=sharing",
...
def download_office_home(data_dir):
    ...
    download_and_extract(" https://drive.google.com/file/d/1USXqK4nCvOAR5Ty4iwKcuCOrRJoRuDyU",
                         os.path.join(data_dir, "office_home.zip"))
